    ...
    return (
        <div className='home__data'>
            ...
            <p className='home__description'>
                I'm web front end developer and designer using React JS library, Professionally and working on powerful,
                flexible and consistent interactive user interfaces.
            </p>
